#Credits to http://www.scconfigmgr.com/author/najtmaregmail-com/
#Taken from http://www.scconfigmgr.com/2016/03/01/remove-built-in-apps-when-creating-a-windows-10-reference-image/
#Added elevated permision
...
function Write-LogEntry {
    ...
    $LogFilePath = Join-Path -Path  "D:\" -ChildPath "Temp\$($FileName)"
